      ...
      <div id="content">
        ...
        <div class="container-fluid">
         <!-- Page Heading -->
          ...
          <a href="input-master.php" class="btn btn-lg btn-success" style="height: 100px; width: 300px; margin-right:20px; margin-top: 10px;" ><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Transaksi Masuk&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a> 
          <a href="input-transaksi-keluar.php" class="btn btn-lg btn-danger" style="height: 100px; width : 300px; margin-right:20px; margin-top: 10px;" ><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Transaksi Keluar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a> 
...
<div class="tab-content pl-3 pt-2" id="nav-tabContent">
              ...
              ?>    
                   ...
                   where stats='OUT' AND Tanggal='$tgl'";
